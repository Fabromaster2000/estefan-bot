...
const LOGO_ESTEFAN = 'https://peluqueria-bot.onrender.com/assets/logo.jpg';
...
<div class="container">
  <div class="header" style="background:#0e0e0e;border-bottom:2px solid #c8a96e;padding:20px 32px;text-align:center;">
    <img src="${LOGO_ESTEFAN}" alt="Estefan" width="160" height="auto" style="display:block;margin:0 auto;max-width:160px;height:auto;border:0;outline:none;text-decoration:none;">
  </div>
  <div class="body">
